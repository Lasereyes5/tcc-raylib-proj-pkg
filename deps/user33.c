// https://github.com/win32ss/VxKex/blob/master/user33%2Fuser33.c
#include <Windows.h>


#ifdef USER33_WIN11
#define USER33_WIN10
#define USER33_WIN8_1
#define USER33_WIN8
#endif
...
BOOL LogicalToPhysicalPoint(IN HWND hWnd, IN OUT LPPOINT lpPoint);
BOOL PhysicalToLogicalPoint(IN HWND hWnd, IN OUT LPPOINT lpPoint);
